...
import { Mino, type LockRes, Engine } from "@haelp/teto/engine";
...
export function lockResultToRes(lockResult: LockRes, engine: Engine): LockResult {
    ...
    if (lockResult.lines > 0) {
        ...
        clearInfo = {
            ...
            downstackCleared: lockResult.garbageCleared,
            clearType,
    ...
    return {
        ...
        clearInfo,
        keypresses: lockResult.keysPresses.length,
        frameDelay: lockResult.pieceTime,
        wellColumn
    }
}
