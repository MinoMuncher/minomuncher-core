import type { BagType, KickTable } from "@haelp/teto/engine";
...
export interface VersusReplay {
    ...
    replay: {
        ...
        rounds: {
            ...
            replay: {
                frames: number;
                events: Types.Game.Replay.Frame[];
                options: {
                    ...
                    bgmnoreset: boolean;
                    countdown: boolean;
                    combotable: Types.Game.ComboTable;
                    ...
                    garbageblocking: Types.Game.GarbageBlocking;
                    ...
                    garbagetargetbonus: Types.Game.GarbageTargetBonus;
                    g: number;
                    gincrease: number;
                    gmargin: number;
                    gravitymay20: boolean;
                    handling: Types.Game.Handling;
                    hasgarbage: boolean;
                    ...
                    nolockout: boolean;
                    openerphase: number;
                    passthrough: Types.Game.Passthrough;
                    precountdown: number;
                    prestart: number;
                    roundmode: Types.Game.RoundingMode;
                    seed: number;
                    seed_random: boolean;
                    slot_bar1: string;
                    ...
                    song: string;
                    spinbonuses: Types.Game.SpinBonuses;
                    usebombs: boolean;
                    username: string;
                    version: number;
                    zoominto: "cinematic" | "slow";
                };
                results: {
                    aggregatestats: {
                        apm: number;
